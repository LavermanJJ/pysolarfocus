...
class HeatingCircuit(Component):
    def __init__(self, input_address=1100, holding_address=32600, api_version: ApiVersions = ApiVersions.V_23_010) -> None:
        ...
        # Register 32607 is written as a whole percentage - the controller rejects
        # anything outside 1 to 100 - but reports it back in tenths, like the
        # humidity input register it feeds.
        self.indoor_humidity_external = DataValue(address=7, multiplier=10, write_multiplier=1, register_type=RegisterTypes.HOLDING)
